...
Up_Bound = [1000 10000];   % Upper bounds on Process Gain and Time constant
Lo_Bound = [-1000 0];      % Lower bounds on Process Gain and Time constant
x_initial_guess = [100 50]; % Initial guess for optimization
...
[optimal_x, fval, exitflag] = fmincon(@x2_opt_fun3, x_initial_guess, [], [], [], [], Lo_Bound, Up_Bound, [], options);
...
save Model_Identification_positive_step_x2(3) xo
